...
- [`convert_tags_to_track()`][mopidy.audio.tags.convert_tags_to_track]
  ...
  every other URI in the same batch. (!2283)

- File extension: Strip whitespace from `local/media_dirs` config options.
  (#1965, !2275)

- Stream extension: Support legacy ASX playlists. (#794, !2281)
